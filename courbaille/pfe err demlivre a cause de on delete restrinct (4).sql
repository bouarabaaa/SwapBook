...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 03 mai 2023 à 20:39
...
(1, 6, 'mon livre', '2023-03-06', 'sport', 14, 8, 'images/book2.jpg', '****************************************************************************************************************                 *******************************************************************************'),
...
(210, 8, 'jsk', '2022-04-01', 'informatique', 9, 20, '', '');
...
(8, 'ronaldo', 'cristiano', 'don', 'don123', 'lisbona', 'lecteur', 22, '2003-06-07', 'images/user1.jpg', 'https://goo.gl/maps/3dw6j3Hv2DR8igZw8'),
...
--
ALTER TABLE `livre2`
  ADD CONSTRAINT `fck6` FOREIGN KEY (`idlivree`) REFERENCES `livre` (`ref`) ON DELETE CASCADE ON UPDATE RESTRICT,
