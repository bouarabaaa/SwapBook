...
<div class="text-center m-5">
        <h1>ajouter offre</h1>
        <p>ajouter offre quizy</p>
    </div>

      <form method="POST">
      <div class="form-group">
    <label for="exampleInputEmail1">duree</label>
    <input type="text" name="dure" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter duree">
    <small id="emailHelp" class="form-text text-muted">la duree de cet offre</small>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">reduction</label>
    <input type="text" name="reduction" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter reduction">
    <small id="emailHelp" class="form-text text-muted">la reduction de cet offre</small>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">point</label>
    <input type="number" name="point" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter point">
    <small id="emailHelp" class="form-text text-muted">le nombre de point necessaire</small>
  </div>
  <div class="form-group">
  ...
  <!--  <input type="text" name="description" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter description">-->
    <textarea name="description" id="exampleInputEmail1" class="form-control" aria-describedby="emailHelp" placeholder="Enter description">description</textarea>
    <small id="emailHelp" class="form-text text-muted">la description de cet offre</small>
  </div>
...
if(isset($_POST['ok'])){
  ...
  $description =$_POST["description"];
        ...
        $req = "INSERT INTO offrequizy (idadminqz,dure,reduction,pointt,descriptionn) VALUES ('$iduser','$dure','$reduction','$point','$description')";
    
       if(mysqli_query($con, $req)){

        echo "
        <script>   alert('votre offre est bien enregistre');</script>";
