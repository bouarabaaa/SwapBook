...
?>
      ...
      <form method="POST">
<h2 class=" m-5 text-danger">vous êtes sûr de vouloir supprimer cet user</h2>
<div class="m-5">
  <input type="submit" value="oui"   class="btn btn-outline-danger"  name="oui"></a>
<a  class="btn btn-outline-primary" href="admin.php" role="button" name="non">non</a>
</div>
...
if(!empty($_GET["idu"])){
  ...
  $idu = $_GET["idu"];
  $reqt = "delete from user where id ='$idu'";
