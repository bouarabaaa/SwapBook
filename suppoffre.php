...
?>
      ...
      <form method="POST">
<h2 class=" m-5 text-danger">vous êtes sûre de vouloir supprimer cet offre</h2>
<div class="m-5">
  <input type="submit" value="oui"   class="btn btn-outline-danger"  name="oui"></a>
<a  class="btn btn-outline-primary" href="quizy.php" role="button" name="non">non</a>
</div>
...
if(!empty($_GET["ido"])){
  ...
  $ido = $_GET["ido"];
  $reqt = "delete from offrequizy where idoffre ='$ido'";
  ...
  if(!$res){
      ...
      echo "
      <script>   alert('user est supprime');</script>";
