...
<div class="text-center m-5">
        <h1>ajouter livre</h1>
        <p>ajoutez livre pour la bibliotheque</p>
    </div>
  ...
  <label for="exampleInputEmail1">l'etat de livre</label>
       ...
       <select name="etat" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
          <option value="admin" name="etat">Neuf</option>
          <option value="quizy" name="etat">Comme neuf</option>
          <option value="bibliotheque" name="etat">Tres bon etat </option>
          <option value="lecterur" name="etat">Bon etat</option>
          <option value="lecterur" name="etat">etat acceptable</option>
...
if($chemin == 0 ){
  $reqqa = "INSERT INTO livre2 (idlivree,iduser,titre,datedition,categorie,nbrexemplaire,pointe,description,etat) VALUES ('$rf','$iduser','$titre','$date','$categorie','$nbrexp','$nbpt','$decs','$etat')";
       ...
       if(mysqli_query($con, $reqqa)){
        ...
        echo "
        <script>   alert('livre existe deja');</script>";
       }
