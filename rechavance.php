...
include "connexion.php";
    ...
    if(!empty($_GET["date"])){
      $gt='date';
        ...
        $reqt = "select * from livre2 where iduser != '$iduser' and EXTRACT(YEAR FROM datedition) ='$d' LIMIT $start, $limit";
        $reqttcn = "SELECT count(idlivree) from livre2 where iduser != '$iduser' and EXTRACT(YEAR FROM datedition) ='$d' ";
      ...
      $gt='cat';
        ...
        $reqt = "select * from livre2 where iduser != '$iduser' and categorie ='$d' LIMIT $start, $limit";
        $reqttcn = "SELECT count(idlivree) from livre2 where iduser != '$iduser' and categorie ='$d'";
      ...
      $gt='ville';
        ...
        $reqt = "select * from livre2 where iduser in (select id from user where ville='$d' and id!='$iduser') LIMIT $start, $limit";
        $reqttcn = "SELECT count(idlivree) from livre2 where iduser in (select id from user where ville='$d' and id!='$iduser')";
    ...
    elseif(!empty($_GET["pt"])){
      ...
      $d=$_GET["pt"];
        ...
        $reqt = "select * from livre2 where iduser != '$iduser' and pointe ='$d' LIMIT $start, $limit";
        $reqttcn = "SELECT count(idlivree) from livre2 where iduser != '$iduser' and pointe ='$d'";
...
$reqt32 = "select * from demlivre where idlctlivre = '$iduser' order by valide";
...
<div class="d-flex justify-content-center m-5">
  ...
  <ul class="pagination">
    <li class="page-item ">
      <a class="page-link" href="rechavance.php?<?= $gt; ?>=<?= $d; ?>&page=<?= $Previous; ?>" tabindex="-1">Previous</a>
    </li>
    ...
    <?php for($i = 1; $i<= $pages; $i++) :
     ...
     ?>
    <li class="page-item <?php echo $pgn; ?>" ><a class="page-link" href="rechavance.php?<?= $gt; ?>=<?= $d; ?>&page=<?= $i; ?>"><?= $i; ?></a></li>

    <?php endfor; ?> 

    <li class="page-item">
      <a class="page-link" href="rechavance.php?<?= $gt; ?>=<?= $d; ?>&page=<?= $Next; ?>" tabindex="-1">Next</a>
    </li>
  </ul>
</nav>
</div>
