...
$rjifhuhi = "select * from user where id='$iduser'";
$rsihuo = mysqli_query($con,$rjifhuhi);
if(!$rsihuo){
  echo"error";
 }else{
   $ln = mysqli_fetch_array($rsihuo);
...
<h1><span class="grtitre2"><span class="cl">M</span>odi<span class="cl">f</span>ier<span class="cl"> Liv</span>re</span></h1>
  ...
  <select name="etat" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php if($ligne) {echo $ligne[9];}?>" required>
