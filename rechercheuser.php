...
include "connexion.php";
    ...
    $reqt = "select * from user where typee !='admin'";



$res = mysqli_query($con,$reqt);
$lv = $_SESSION['livrerechercheadmin'];
$rqttt2="select * from user where username like '%$lv%' and id!='$iduser'";
$res2 = mysqli_query($con,$rqttt2);
if(!$res){
  echo"error";
 }
...
<!--jai fait ca pour separer les deux container -->
    <div class="text-center m-5">
        <h1>user</h1>
        <p>vous allez trouver les tous les users ici</p>
    </div>
    <div class="sp">
    <div class="row">
...
if($res2->num_rows>0){
    ...
    while($ligneres=mysqli_fetch_array($res2)){
      ...
      if($ligneres[6]=="lecteur"){$point=$ligneres[7]." points";}else{$point="";}
  ...
  <div class="card__content">
    ...
    <span class="card__name text-danger">'.$nrsignale.'</span>
