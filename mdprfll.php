...
<h1><span class="grtitre2"><span class="cl">M</span>odi<span class="cl">f</span>ier<span class="cl"> Pro</span>fil</span></h1>
        <p>modifier profil lecteur</p>
    </div>
    ...
    <input type="text" name="nom" class="form-control" id="exampleInputEmail1" value="<?php if($ligne) {echo $ligne[1];} ?>"  placeholder="entrer votre nom" required>
    <small id="emailHelp" class="form-text text-muted">modifier votre nom</small>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">prenom</label>
    <input type="text" name="prenom" class="form-control" id="exampleInputEmail1" value="<?php if($ligne) {echo $ligne[2];}?>" placeholder="entrer votre nom" required>
    <small id="emailHelp" class="form-text text-muted">modifier votre prenom</small>
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1">username</label>
    <input type="text" name="username" class="form-control" id="exampleInputEmail1" value="<?php  if($ligne) {echo $ligne[3];} ?>"  placeholder="entrer votre username" required>
    <small id="emailHelp" class="form-text text-muted">modifier votre username</small>
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1">password</label>
    <input type="password" name="pass" class="form-control" id="exampleInputEmail1" value="<?php if($ligne) {echo $ligne[4];}?>" placeholder="entrer votre password" required>
    <small id="emailHelp" class="form-text text-muted">modifier votre password </small>
  </div>

  <div class="form-group">
    <label for="exampleInputEmail1">ville</label>
    <input type="text" name="ville" class="form-control" id="exampleInputEmail1" value="<?php  if($ligne) {echo $ligne[5];} ?>"  placeholder="entrer votre ville" required>
  ...
  <select name="sexe" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php if($ligne) {echo $ligne[11];}?>" required>
   ...
   <div class="form-group">
  <label for="exampleInputEmail1">la specialite</label>

  <select name="spe" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php if($ligne) {echo $ligne[13];}?>" required>
          <option value="medcine" name="spe">medcine</option>
          <option value="autre" name="spe">autre</option>

   
       </select>
       <small id="emailHelp" class="form-text text-muted">preciser votre specialite</small>
   </div>
...
if(isset($_FILES['avatar']) and !empty($_FILES['avatar']['name'])){
  ...
  if (file_exists($avatar)) {
    ...
    if(in_array($extensionUpload, $extensionsvalides)){
      $chemin = "images/".$_SESSION["user"][0].".".$extensionUpload;
      $resultat = move_uploaded_file($_FILES['avatar']['tmp_name'], $chemin);
      
      if($resultat){ 
        $cavatar = $_SESSION["user"][0].".".$extensionUpload;
        
       echo $cavatar;
        
        $cid = $_SESSION["user"][0];
        
        $updateavatar = "UPDATE user set srcimage = '$chemin' where id = '$cid' ";
...
if(isset($_POST['ok'])){
  ...
  $spe =$_POST["spe"];
        ...
        $req2 = "UPDATE user set nom='$nom',prenom='$prenom',username='$username',pass='$password',ville='$ville',datenaissance='$datens',localisation='$loc',sexe='$sexe',specialite='$spe' where id=$iduser";
