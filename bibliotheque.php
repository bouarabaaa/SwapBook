...
?>
    ...
    $reponse= $con->query($r);
    $_SESSION['livrerecherchebib'] = $recherche;
    if($reponse->num_rows>0){



      echo '<script>  window.location.href="recherchemslvrsbib.php"  </script>';
...
<div class="row m-2">
           ...
           <div class="card__content sd">
             ...
             <div class="dropdown sh">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="modifierprofilbib.php">modifier</a>
      ...
      <!--jai fait lg md sm pour respecter respence-->
        ...
        <div class="swiper-wrapper">
              ...
              {
                $rqtdem="select * from demlivre where idlctlivre='$iduser' and idlivr='$ligne[0]'";
                $resdem=mysqli_query($con,$rqtdem);
            ...
            <p class="card-text text-light">categorie : '.$ligne[4].'</p>
            ...
            <p class="card-text text-light">la demende:'.$resdem->num_rows.' </p>


            
                <a href="supplivrbib.php?idl='.$idl.'&idu='.$idu.'" class="btn btn-primary mb-0">supprimer</a>
                <a href="modifierlivrebib.php?idl='.$idl.'&idu='.$idu.'" class="btn btn-primary mb-0">modifier</a>
              </div>
              </div>
